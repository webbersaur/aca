      ...
      fetch('/api/contact', {
        ...
        .then(function (result) {
          if (result.ok) {
            ...
            setStatus((result.data && result.data.error) || 'Something went wrong. Please call us at (203) 996-5956.', 'error');
          }
        })
        .catch(function () {
          setStatus('Network error. Please call us at (203) 996-5956.', 'error');
        })
        .finally(function () {
